...
CONT__ALL	= $(CONT_DB) $(CONT_APP) $(CONT_NGINX)
...
.PHONY:		all clean fclean re up build migrate collectstatic createsuperuser stop rm_containers rm_volumes init init_restore